...
LTRESULT CConsole::LoadBackground()
{
	...
	if ( pcx_Create2(pStream, &bitmap) )
	{
		...
		m_bBackgroundOptimized = ilt_client->OptimizeSurface(m_hBackground, CONRGB(0,0,0)) != 0;
